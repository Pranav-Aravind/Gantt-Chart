...
/*
 * This function will display Ascii art that our group decided as its signature
 * The function is void in parameters and return value.
 * It shows a Keith Haring's piece called "Radiant baby".
 * */
void asciiArt()
{
	printf("\n\n\t++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n");
